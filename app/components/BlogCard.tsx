...
export default function BlogCard({
    ...
    return (
        <article className="group overflow-hidden rounded-[28px] bg-[#ECECEC] p-4 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl">
            <Link
            ...
            >
                <div className="overflow-hidden rounded-2xl">
                    <Image
                        ...
                        width={900}
                        height={600}
                        className={`w-full object-cover object-top transition-transform duration-700 ease-[cubic-bezier(.22,1,.36,1)] group-hover:scale-110 aspect-video`}
                    />
                </div>
                ...
                <div className="mt-6 flex justify-between gap-4">
                    <div>
                        <h3
                            className={`line-clamp-2 font-mona-bold uppercase leading-tight transition-colors duration-300 group-hover:text-[#0079FF] ${large
