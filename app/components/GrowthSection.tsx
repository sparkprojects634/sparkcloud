...
const GrowthSection = () => {
  ...
  return (
    <section className="relative min-h-[225vh] lg:min-h-[250vh] bg-black rounded-t-4xl overflow-hidden">
      ...
      <div className="text-white absolute w-full bottom-0 flex h-screen flex-col items-center justify-center gap-4 lg:gap-8">
        ...
        <p className='text-sm md:text-2xl lg:text-3xl tracking-wide'>We bridge the gap between your brand and your customers.</p>
      </div>
