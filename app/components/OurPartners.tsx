    ...
    return (
        <section className="py-20 md:py-28">
            <div className="mx-auto w-full max-w-350 px-5 md:px-8">
                <h2 className="mb-14 text-center font-mona-bold text-5xl font-monosans font-semibold uppercase tracking-normal text-neutral-400 md:mb-20 md:text-7xl lg:text-8xl">
