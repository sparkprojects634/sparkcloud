...
export const BetterWebsiteData = [
    {
        id: '01',
...
export const TestimonialsData = [
    {
        id: 1,
        quote:
            '"Sparkcloud completely transformed the way our business looks online. The website feels modern, professional and, most importantly, our customers actually find it easy to use."',
        name: 'Lucas Moore',
        role: 'Web Developer',
    },
    {
        id: 2,
        quote:
            '"The entire process was much easier than we expected. The team understood what we wanted and turned our ideas into a website that looks amazing."',
        name: 'Amanda Smith',
    ...
    },
    {
        id: 3,
        quote:
            '"We needed a website quickly and Sparkcloud delivered without compromising on quality. The final result was better than what we had imagined."',
        name: 'Daniel Johnson',
...
export const FAQData = [
    {
        ...
        answer:
            'Most websites take around 2–6 weeks depending on the size, functionality, content and level of customization required.',
    },
    {
        id: 2,
        question: 'Do I need to provide the content?',
        answer:
            'You can provide your own content, or we can help you structure and prepare the content required for your website.',
    },
    {
        id: 3,
        question: 'Can you redesign my existing website?',
        answer:
            'Yes. We can redesign your existing website with a modern visual system, improved user experience and responsive development.',
    },
    {
        id: 4,
        question: 'Will my website work on mobile phones?',
        answer:
            'Yes. Every website is designed and developed to work smoothly across mobile phones, tablets and desktop devices.',
    },
    {
        id: 5,
        question: 'Can you build an e-commerce website?',
        answer:
            'Yes. We can build e-commerce websites with product management, payments, shipping, customer accounts and other required functionality.',
    },
]
